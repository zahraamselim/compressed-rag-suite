...
# Format: {'tdp': watts, 'tflops': fp16 peak, 'memory_gb': VRAM}
GPU_SPECS = {
    ...
    'rtx 5090': {'tdp': 575.0, 'tflops': 125.0, 'memory_gb': 32},  # Estimated
...
def detect_tdp(is_cuda: bool) -> float:
    ...
    """
    if not is_cuda:
        # CPU default (conservative estimate)
        return 15.0
    ...
    try:
        ...
        # Try to match GPU name with database
...
def get_device_specs(is_cuda: bool) -> Dict[str, any]:
    ...
    specs = {
        ...
        'device_name': None,
        'tdp_watts': detect_tdp(is_cuda),
        'peak_tflops': detect_peak_tflops(is_cuda),
        'memory_gb': None,
