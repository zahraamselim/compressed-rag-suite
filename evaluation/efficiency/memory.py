...
def get_bits_per_param(model) -> float:
    ...
    try:
        ...
        # Check for quantization (bitsandbytes, GPTQ, etc.)
        if hasattr(sample_param, 'quant_state'):
            ...
            # Determine bits from quantization type
            ...
            # Use actual if close to theoretical, otherwise use theoretical
            # (actual might include overhead)
        ...
        # Check data type for non-quantized models
...
def estimate_kv_cache_size(
    ...
    try:
        ...
        # KV cache: 2 (K and V) * num_layers * batch_size * num_heads * seq_len * head_dim * bytes
        kv_cache_bytes = (
