...
class HuggingFaceModel(ModelInterface):
    ...
    Works with any model on HuggingFace Hub or local path.
    """
    ...
    def load(
        ...
        **kwargs
        ...
        try:
            ...
            # Set pad token in generation config
            ...
            if 'gpu_memory_allocated_gb' in info:
                logger.info(f"  GPU Memory Allocated: {info['gpu_memory_allocated_gb']:.2f} GB")
                logger.info(f"  GPU Memory Reserved: {info['gpu_memory_reserved_gb']:.2f} GB")
